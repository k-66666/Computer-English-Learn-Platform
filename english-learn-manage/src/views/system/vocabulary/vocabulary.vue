<template>
  <div class="_vocabulary">
      <div class="search-table">
        <div class="search">
            <el-row :gutter="10" style="padding:10px">
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <span class="search-title">英文:</span>
                    <el-input
                ...
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <span class="search-title">中文:</span>
                    <el-input
                        style="margin-top:10px"
                        size="mini"
                        placeholder="键入中文以搜索"
                        v-model="search.definition">
                    </el-input>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
...
<script>
  import {getApeVocabularyPage,removeApeVocabulary} from '../../../api/api' 
  import add from '../../../components/system/vocabulary/addVocabulary'
  import update from '../../../components/system/vocabulary/updateVocabulary'
  export default {
    data() {
      return{
        loading: true,
    ...
    methods: {
      ...
      query() {
        getApeVocabularyPage(this.search).then(res => {
          if(res.code == 1000) {
      ...
      deleteDate(ids) {
        removeApeVocabulary({ids:ids}).then(res => {
            if(res.code == 1000) {
              this.$message({
                type: 'success',
                message: '删除成功!'
