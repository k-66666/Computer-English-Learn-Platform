<template>
<div>
  <el-dialog title="新增部门" width="40%" :destroy-on-close="true" :visible.sync="addDeptVisible" :before-close="handleClose">
...
<script>
  ...
  export default {
    ...
    props: ['addDeptVisible','dropData','parentId','disable'],
    methods: {
      submit() {
