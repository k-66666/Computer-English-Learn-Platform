    ...
    <transition appear name="opacitytrans">
      <div class="container" id="container">
        <div class="form-container sign-in-container">
          <form action="#">
            <h2>code learning English Platform</h2>
            <span>code learning英语学习平台</span>
            <input type="text" placeholder="账号" v-model="loginAccount" />
            <input type="password" placeholder="密码" v-model="password" />
            <div class="button" @click="login()" >登录</div>
            <span style="margin-top:10px" @click="toRegister">没有账号，前往注册？</span>
            <span style="margin-top:10px" @click="toForget">忘记密码？</span>
          </form>
        </div>
          ...
          <div class="overlay">
            <div class="overlay-panel overlay-right">
              ...
              <p style="color:#ffffff">
                [EL Online English Learning System]
              </p>
            </div>
          </div>
        </div>
